...
try:
    ...
    captions = [
        ...
        f"{trend_interpretation_m} We can also observed that there are month where on average, donors mostly donate blood on the month {monthly_highest_value_index} with *{highest_value_monthly}*. Meanwhile on month {monthly_lowest_value_index} is the least people will go donate blood with {lowest_value_monthly}.",
